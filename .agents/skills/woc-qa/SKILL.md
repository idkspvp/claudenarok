---
name: woc-qa
description: "Run end-of-contribution QA for Claudenarok Online, including readiness checks, scoped regression testing, and conditional specialist review. Use when asked to QA changes, make work ready, verify a branch or worktree, or assess whether a contribution is complete."
---

# Claudenarok Online QA
