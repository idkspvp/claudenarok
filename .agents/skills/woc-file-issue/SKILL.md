---
name: woc-file-issue
description: "Draft and create a focused GitHub issue for Claudenarok Online using the project issue format. Use only when the user explicitly asks to file, create, or open an issue. A request for a draft does not authorize creating the issue."
---

# File GitHub Issue

Create a clear, bounded issue in `idkspvp/claudenarok`.
