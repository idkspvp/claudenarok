...
export const PUBLIC_CARD_COPY: Record<PublicCardLocale, PublicCardCopy> = {
  en: {
    ...
    description: '{name} is forging a legend in Claudenarok Online. Join the realm.',
    ...
    missingCta: 'Enter Claudenarok Online',
    classes: EN_CLASSES,
  },
  es: {
    gameName: 'Claudenarok Online',
    ...
    description: '{name} está forjando una leyenda en Claudenarok Online. Únete al reino.',
  ...
  fr_FR: {
    ...
    description: '{name} forge sa légende dans Claudenarok Online. Rejoignez le royaume.',
  ...
  it_IT: {
    ...
    description: '{name} sta forgiando una leggenda in Claudenarok Online. Entra nel reame.',
  ...
  de_DE: {
    ...
    description: '{name} schmiedet eine Legende in Claudenarok Online. Betretet das Reich.',
  ...
  zh_CN: {
    ...
    description: '{name} 正在 Claudenarok Online 中铸就传奇。加入这个国度。',
    cta: '铸就你的传奇',
    missingTitle: '未找到卡片',
  ...
  zh_TW: {
    ...
    description: '{name} 正在 Claudenarok Online 中鑄就傳奇。加入這個國度。',
    cta: '鑄就你的傳奇',
    missingTitle: '找不到卡片',
  ...
  ko_KR: {
    ...
    description:
      '{name}님이 Claudenarok Online에서 전설을 만들어 가고 있습니다. 세계에 합류하세요.',
    cta: '나만의 전설 만들기',
  ...
  ja_JP: {
    ...
    description: '{name} は Claudenarok Online で伝説を築いています。王国に参加しましょう。',
    cta: '自分の伝説を築く',
  ...
  pt_BR: {
    ...
    description: '{name} está forjando uma lenda em Claudenarok Online. Entre no reino.',
    cta: 'Forje sua lenda',
  ...
  ru_RU: {
    ...
    description: '{name} создает легенду в Claudenarok Online. Присоединяйтесь к миру.',
