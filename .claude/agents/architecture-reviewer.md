...
description: >
  ...
  Claudenarok. `src/sim/sim.ts` is a thin coordinator over sibling game-system modules behind
...
You are the determinism and seam reviewer for the `src/sim/` core of Claudenarok Online. The
