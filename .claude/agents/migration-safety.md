...
description: >
  Schema and persisted-state safety analyzer for Claudenarok Online (Postgres via `pg`).
...
You are a database schema and persistence auditor for Claudenarok Online (PostgreSQL,
