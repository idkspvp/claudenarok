...
describe('stripReleaseNotesPreamble', () => {
  const v26 = [
    '# Claudenarok Online v0.26.0 Release Notes',
    '',
    '**Release:** v0.26.0',
    '**Date:** 2026-07-15',
  ...
  it('strips the shape with no Date row (the v0.24.2 variant)', () => {
    const md = '# Claudenarok Online v0.24.2 Release Notes\n\n**Release:** v0.24.2\n\nBody.';
    expect(stripReleaseNotesPreamble(md)).toBe('Body.');
  });

  it('strips the hyphenated h1 variant', () => {
    const md = '# Claudenarok Online - v0.24.0 Release Notes\n\nBody.';
    expect(stripReleaseNotesPreamble(md)).toBe('Body.');
  });
      ...
      [
        {
          id: 1,
          tag: 'v0.26.0',
          name: 'Claudenarok Online v0.26.0',
