...
export const ja_JP: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "bracing_roll": {
        "name": "ブレイスロール",
        "description": "前方へ8ヤード転がり、拘束を解除し、1秒間すべてのダメージを無効化する。"
      },
      "shadowslip": {
        "name": "シャドウスリップ",
        "description": "前方へ8ヤード滑り込み、拘束を解除し、1秒間あらゆるダメージをすり抜ける。"
      },
      "wildstep": {
        "name": "ワイルドステップ",
        "description": "前方へ8ヤード跳躍し、拘束を解除し、1秒間ダメージを受けない。"
      },
      "phase_tumble": {
        "name": "フェイズタンブル",
        "description": "前方へ8ヤード転がり、拘束を解除し、1秒間位相をずらしてすべてのダメージを回避する。"
      },
      "veilstep": {
        "name": "ヴェイルステップ",
        "description": "帳の向こうへ8ヤード踏み込み、拘束を解除し、1秒間ダメージを受けない。"
      },
      "sanctified_sidestep": {
        "name": "聖別のサイドステップ",
        "description": "前方へ8ヤード踏み出し、拘束を解除し、1秒間すべてのダメージを受け流す。"
      },
      "galestep": {
        "name": "ゲイルステップ",
        "description": "疾風に乗って前方へ8ヤード進み、拘束を解除し、1秒間ダメージを受けない。"
      },
      "dreadstep": {
        "name": "ドレッドステップ",
        "description": "闇を抜けて前方へ8ヤード踏み出し、拘束を解除し、1秒間ダメージを受けない。"
      },
      "feral_tumble": {
        "name": "フェラルタンブル",
        "description": "前方へ8ヤード転がり、拘束を解除し、1秒間ダメージを受けない。"
      },
      "bear_charge": {
        "name": "ブルーインラッシュ",
