...
export const en: EnTranslations = {
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "Wallet connections are not available in the Home Screen app yet. Open Claudenarok Online in Safari or Chrome to use Phantom or Solflare.",
    ...
    "manualReturnStandaloneHelp": "After approval, return to Claudenarok Online from your Home Screen. If iOS opens a browser, close it and reopen the Home Screen app manually.",
  ...
  "playerCard": {
    ...
    "shareText": "I'm forging my legend in Claudenarok Online: Level {level} {className}{tierBit}. Join my world:",
