...
export const en: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "dailyRewards": {
      ...
      "intro": "Earn points with one daily spin and rotating tasks. The top scorers of the day share the prize pool.",
      "prize": "Prize Pool",
      "reset": "Reset",
      "endsIn": "Ends in {time}",
    ...
    "nativeUpdate": {
      ...
      "bodyWithVersion": "Version {version} of Claudenarok Online is available. Update now for the latest fixes and improvements.",
      "notNow": "Not now",
      "update": "Update"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "footer": {
      "blurb": "An open-source, classic-style micro-MMO. Hunt, group up, and explore a hand-built world, right in your browser.",
      "playNow": "Play Now",
    ...
    "howToPlay": {
      "intro": "New to this kind of game? You will be fighting in minutes. Here is the short version, one step at a time.",
      ...
      "step2Body": "Open your character sheet with C. A new hero holds status points to place across Strength, Agility, Vitality, Intelligence, Dexterity, and Luck. They are what make two heroes of the same class different, and you can always take them back and spend them again.",
      ...
      "step5Body": "Press F on a fallen enemy to loot it. Coin, gear, and crafting materials all come off the things you kill.",
      "step6Title": "Keep going",
      "step6Body": "You just hit level 2. Head out of town, hunt what you can handle, and the world opens up from there. Every level hands you more points to place.",
      ...
      "statusPointsBody": "Every level grants points to place across the six attributes, and the cost of a point rises as an attribute climbs. That price is the whole game of building a hero: nobody can afford to be good at everything, so what you leave behind matters as much as what you take.",
      ...
      "groupingBody": "Invite others to a party to share kill credit and take on dungeons. Most of the world is soloable, so grouping is a choice, not a chore.",
    ...
    "combat": {
      ...
      "growBody": "Each level makes you tougher, unlocks new abilities, and hands you status points to place, all the way to the cap of level {cap}. Hunting is the way up; dungeon runs and delves round it out.",
    ...
    "worldPage": {
      "heading": "The world",
      "intro": "Claudenarok Online is one continuous land you cross on foot, three zones laid south to north. There is no fast travel, so the journey is part of the adventure.",
      "hub": "Home base",
      "mapHeading": "The road north",
      "mapSub": "Three zones, south to north, each a step higher in level. Follow the road north and the land carries you from the valley to the peaks.",
  ...
  "playerCard": {
    ...
    "arenaStat": "Arena",
    "shareText": "I'm forging my legend in Claudenarok Online: Level {level} {className}. Join my world:",
  ...
  "seo": {
    "title": "Claudenarok Online: Classic-Style Web MMO",
    "description": "Embark on an epic adventure in Claudenarok Online, a classic-style micro-MMO playable directly in your browser. Join a persistent shared world, level up classes, and defeat enemies!",
    "genre": "MMORPG",
    "playMode": "Multiplayer",
    "applicationCategory": "Game",
    "operatingSystem": "Web browser",
    "officialLabel": "Official Claudenarok Online website",
  ...
  "a11y": {
    ...
    "githubProject": "Open the Claudenarok Online GitHub project",
    "discordCommunity": "Join the Claudenarok Online Discord community",
    "donateProject": "Donate to support Claudenarok Online"
  },
  "entryGuard": {
  ...
  "classDetails": {
    ...
    "lore": {
      "swordman": "Warriors are battle-hardened melee fighters who build Rage as they deal or take damage. They absorb heavy hits or crush foes with powerful weapons.",
      "archer": "Scouts are ranged specialists who fight beside a tamed beast, peppering enemies with aimed and rapid shots, slowing them with stings and concussive fire, and shifting aspects to suit the moment.",
      "thief": "Rogues are stealthy assassins who spend Energy and Combo Points on backstabs and finishing moves from the shadows.",
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Open Claudenarok Online from the new Home Screen icon.",
    ...
    "androidOpenStep": "Open Claudenarok Online from the new icon.",
  ...
  "serverUnavailable": {
    "title": "Claudenarok Online - World Unavailable",
    "logoAlt": "Claudenarok Online",
  ...
  "entities": {
    "abilities": {
      ...
      "greater_invisibility": {
        ...
        "description": "Vanish for 20 sec: removes 2 damage-over-time effects and you take 90% less damage while invisible and shortly after."
      },
      "hot_streak": {
        "name": "Hot Streak",
      ...
      "mass_barrier": {
        "name": "Mass Barrier",
        "description": "Shields you and up to 4 nearby allies within 30 yd, each absorbing 130 damage for 60 sec."
      },
      "overload": {
        "name": "Overload",
      ...
      "rune_of_power": {
        "name": "Rune of Power",
        "description": "Inscribe a rune of power at your feet for 15 sec: allies standing within 8 yd deal 10% more damage."
      },
      ...
      "blizzard": {
        "name": "Blizzard",
        "description": "Calls an ice storm onto the target area for 6 sec, dealing {damage} Frost damage each second and slowing enemies by 40%. Each enemy struck shaves 0.5 sec off Rimeglobe, up to 3 sec per cast. (Frost)"
      },
      "glacial_spike": {
        "name": "Glacial Spike",
      ...
      "whirlwind": {
        "name": "Bladed Gyre",
        "description": "Spin in a deadly arc, striking all nearby enemies for {damage}."
      },
      "berserker_rage": {
        "name": "Seething Fury",
        "description": "Enter a seething fury, generating 20 rage."
      },
      "crusader_strike": {
        "name": "Crusader Strike",
        "description": "Strikes the target for weapon damage plus {damage} Holy damage."
      },
      "chain_heal": {
        "name": "Chain Heal",
      ...
      "aura_surge": {
        ...
        "description": "Hurl a dawnforged shield for {damage} Holy damage and silence the primary target for 2 sec. It bounces to up to 2 additional enemies within 10 yd for 75% damage per bounce."
      },
      "holy_shield": {
        "name": "Hallowed Wall",
      ...
      "aspect_of_the_wild": {
        "name": "Wildfang Rally",
        "description": "Inspires allies within 30 yd with wild strength, increasing attack power by 45 and attack speed by 5% for 5 min."
      },
      "avatar": {
        "name": "Ironshape",
      ...
      "avenging_wrath": {
        "name": "Wrathwing",
        "description": "Calls down avenging power, increasing attack power by 60 and spell power by 30 for 20 sec."
      },
      "berserk": {
        "name": "Red Haze",
        "description": "Increases attack power by 70 for 15 sec."
      },
      "bladestorm": {
      ...
      "bloodlust": {
        "name": "Storm Chorus",
        "description": "Whips your group or raid into a frenzy, increasing attack, casting, and channeling speed by 30% for 15 sec. Allies recently affected by Storm Chorus or Temporal Acceleration are too exhausted to benefit."
      },
      "chain_lightning": {
        "name": "Skybranch",
        "description": "Hurls lightning at the target area, damaging nearby enemies for {damage}."
      },
      "chaos_bolt": {
        "name": "Ruinbolt",
        "description": "Hurls a bolt of chaotic fire for {damage} Fire damage."
      },
      "cleansing_verdict": {
      ...
      "cloak_of_shadows": {
        "name": "Shadecloak",
        "description": "Wraps you in shadows, absorbing 420 damage for 5 sec."
      },
      "cone_of_cold": {
        "name": "Frostsweep",
        "description": "Blasts nearby enemies with frost for {damage} Frost damage."
      },
      "counterspell": {
        "name": "Spellbreak",
        "description": "Counters enemy spellcasting, preventing any spell in that school from being cast for 6 sec."
      },
      "curse_of_exhaustion": {
        "name": "Leaden Hex",
        "description": "Curses the target, slowing movement by 30% for 12 sec."
      },
      "death_coil": {
        "name": "Morrowlash",
        "description": "Strikes the enemy for {damage} Shadow damage, then horrifies them for 3 sec."
      },
      "deep_freeze": {
        "name": "Deadfrost",
        "description": "Deep freezes the target, dealing {damage} Frost damage and stunning it for 4 sec."
      },
      "desperate_prayer": {
        "name": "Last Prayer",
        "description": "Instantly heals you for {damage}."
      },
      "deterrence": {
        "name": "Bristleguard",
        "description": "Increases your dodge chance by 25 percentage points and reduces all damage taken by 30% for 10 sec."
      },
      "divine_shield": {
        "name": "Lightward",
        "description": "Shields you with holy power, absorbing 900 damage for 8 sec."
      },
      "earthbind": {
        "name": "Gripping Earth",
        "description": "Binds nearby enemies to the earth, rooting them for 2 sec."
      },
      "evocation": {
        "name": "Aetherwell",
        "description": "Channel for 6 sec: each second restores 100 mana and builds 8 spell power, stacking while you channel."
      },
      ...
      "frost_trap": {
        "name": "Rime Snare",
        "description": "Places a frost trap at your feet that arms after 1.5 sec. The first enemy to touch it is frozen for 3 sec, unable to move or act. One trap at a time. Lasts 60 sec."
      },
      "ghostly_strike": {
        "name": "Wraith Strike",
        "description": "Strikes the enemy for weapon damage plus {damage} and briefly increases dodge. Awards 1 combo point."
      },
      "hammer_of_wrath": {
        "name": "Tolling Hammer",
        "description": "Hurls a holy hammer at a wounded enemy for {damage} Holy damage. Only usable below 20% health."
      },
      "healing_stream": {
        "name": "Springwell",
        "description": "Restores 120 health to a friendly target over 12 sec."
      },
      "holy_wrath": {
        "name": "Saint's Ire",
        "description": "Unleashes holy power, damaging nearby enemies for {damage}."
      },
      "howl_of_terror": {
        "name": "Dread Chorus",
        "description": "Frightens nearby enemies for up to 3 sec. Damage may break the effect."
      },
      "ice_block": {
        "name": "Cold Coffin",
        "description": "Encases you in ice, absorbing a massive amount of damage for 8 sec."
      },
      "inner_focus": {
        "name": "Stilled Mind",
        "description": "Makes your next spell free. Lasts 60 sec."
      },
      "innervate": {
        "name": "Lifesap",
        "description": "Living sap wells up in you for 10 sec, restoring 20 of your current resource in waves: mana, Rage, or Energy, and shifting forms does not break it. Sleep, stun, or stasis stills the sap."
      },
      "pummel": {
        "name": "Jawcrack",
      ...
      "mend_pet": {
        "name": "Patch Up",
        "description": "Heals a friendly target for {damage} over 15 sec."
      },
      "meteor": {
        "name": "Skystone",
        "description": "Calls down a meteor at the target area, dealing {damage} Fire damage and burning the ground."
      },
      "temporal_mend": {
        "name": "Temporal Mend",
      ...
      "mind_sear": {
        "name": "Thoughtburn",
        "description": "Channels shadow energy at the target area, damaging nearby enemies each second for {damage}."
      },
      "multi_shot": {
        "name": "Splitshot",
        "description": "Loose a spread at the target area, dealing {damage} Physical damage to enemies within 8 yd."
      },
      "prayer_of_healing": {
        "name": "Choirmend",
        "description": "Heals nearby allies for {damage}."
      },
      "preparation": {
        "name": "Contingency",
        "description": "Finishes the cooldown on Swift Heels, Ghostfoot, and Smokestep."
      },
      "presence_of_mind": {
        "name": "Racing Mind",
      ...
      "psychic_scream": {
        ...
        "description": "Frightens nearby enemies for up to 4 sec. Damage may break the effect."
      },
      "counter_shot": {
        "name": "Hushing Shot",
      ...
      "shadowstep": {
        "name": "Shadeslip",
        "description": "Steps through the shadows toward your target without breaking Duskveil."
      },
      "silence": {
        "name": "Hushword",
        "description": "Silences the target for 4 sec."
      },
      "smoke_screen": {
        "name": "Smoke Screen",
      ...
      "tranquility": {
        "name": "Gladesong",
        "description": "Channels restorative energy for 4 sec, healing allies within 30 yd for 42 to 52 each second."
      },
      "typhoon": {
        "name": "Typhoon",
