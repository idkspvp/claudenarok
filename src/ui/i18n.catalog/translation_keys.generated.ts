...
export type TranslationKeyFlat =
  ...
  | 'classDetails.lore.acolyte'
  | 'classDetails.lore.archer'
  | 'classDetails.lore.knight'
  | 'classDetails.lore.mage'
  | 'classDetails.lore.summoner'
  | 'classDetails.lore.swordman'
  | 'classDetails.lore.thief'
  | 'classDetails.resources.energy'
  | 'classDetails.resources.mana'
  | 'classDetails.resources.rage'
  | 'classDetails.roles.acolyte'
  | 'classDetails.roles.archer'
  | 'classDetails.roles.knight'
  | 'classDetails.roles.mage'
  | 'classDetails.roles.summoner'
  | 'classDetails.roles.swordman'
  | 'classDetails.roles.thief'
  ...
  | 'classDetails.weapons.spearsShields'
  ...
  | 'classes.mageAria'
  | 'classes.summoner'
  | 'classes.summonerAria'
  | 'classes.swordman'
  | 'classes.swordmanAria'
  | 'classes.thief'
  | 'classes.thiefAria'
  ...
  | 'entities.items.card_bog_bloat.name'
  | 'entities.items.card_boneclad_revenant.name'
  | 'entities.items.card_deeprock_kobold.name'
  | 'entities.items.card_drowned_dead.name'
  | 'entities.items.card_emberkin.name'
  | 'entities.items.card_forest_wolf.name'
  | 'entities.items.card_gloomshade.name'
  | 'entities.items.card_gravecaller_cultist.name'
  | 'entities.items.card_hollow_acolyte.name'
  | 'entities.items.card_korzul_the_gravewyrm.name'
  | 'entities.items.card_marrowlord_varkas.name'
  | 'entities.items.card_mire_prowler.name'
  | 'entities.items.card_mire_widow.name'
  | 'entities.items.card_mogger.name'
  | 'entities.items.card_moonspawn.name'
  | 'entities.items.card_mudfin_murloc.name'
  | 'entities.items.card_nythraxis.name'
  | 'entities.items.card_ogre_crusher.name'
  | 'entities.items.card_raised_bonewalker.name'
  | 'entities.items.card_restless_bones.name'
  | 'entities.items.card_ridge_stalker.name'
  | 'entities.items.card_thornpeak_ogre.name'
  | 'entities.items.card_thunzharr_waking_peak.name'
  | 'entities.items.card_tunnel_rat.name'
  | 'entities.items.card_vale_bandit.name'
  | 'entities.items.card_voskar_emberwing.name'
  | 'entities.items.card_warlock_imp.name'
  | 'entities.items.card_webwood_spider.name'
  | 'entities.items.card_wild_boar.name'
  | 'entities.items.card_wyrmcult_necromancer.name'
  | 'entities.items.card_ysolei.name'
  ...
  | 'guide.chooser.role'
  | 'guide.chooser.style'
  | 'guide.classHook.acolyte'
  | 'guide.classHook.archer'
  | 'guide.classHook.druid'
  | 'guide.classHook.mage'
  | 'guide.classHook.paladin'
  | 'guide.classHook.shaman'
  | 'guide.classHook.swordman'
  | 'guide.classHook.thief'
  ...
  | 'guide.howToPlay.statusPointsBody'
  | 'guide.howToPlay.statusPointsTitle'
  ...
  | 'hudChrome.auraEffect.increase.luk'
  | 'hudChrome.auraEffect.increase.sp'
  | 'hudChrome.auraEffect.increase.vit'
  ...
  | 'hudChrome.auraEffect.increasePct.vit'
  ...
  | 'hudChrome.auraEffect.reduce.luk'
  | 'hudChrome.auraEffect.reduce.vit'
  ...
  | 'hudChrome.derivedStats.aspd'
  | 'hudChrome.derivedStats.atk'
  | 'hudChrome.derivedStats.crit'
  | 'hudChrome.derivedStats.def'
  | 'hudChrome.derivedStats.flee'
  | 'hudChrome.derivedStats.heading'
  | 'hudChrome.derivedStats.hit'
  | 'hudChrome.derivedStats.matk'
  | 'hudChrome.derivedStats.mdef'
  ...
  | 'hudChrome.npcServices.bank'
  | 'hudChrome.npcServices.heroicVendor'
  | 'hudChrome.npcServices.market'
  | 'hudChrome.npcServices.train'
  | 'hudChrome.npcServices.unbind'
  | 'hudChrome.npcServices.vendor'
  ...
  | 'hudChrome.statInfo.desc.luk'
  | 'hudChrome.statInfo.desc.parry'
  | 'hudChrome.statInfo.desc.spellPower'
  | 'hudChrome.statInfo.desc.str'
  | 'hudChrome.statInfo.desc.vit'
  ...
  | 'hudChrome.statusPoints.maxed'
  | 'hudChrome.statusPoints.none'
  | 'hudChrome.statusPoints.raise'
  | 'hudChrome.statusPoints.raiseUnaffordable'
  | 'hudChrome.statusPoints.remaining'
  | 'hudChrome.statusPoints.reset'
  | 'hudChrome.statusPoints.resetConfirm'
  | 'hudChrome.statusPoints.resetTitle'
