...
export const hudChromeStrings = {
  ...
  statInfo: {
    ...
    desc: {
      ...
      vit: 'Toughens your body, raising your maximum health and how quickly you recover health while resting.',
      int: "Expands a spellcaster's mana pool and improves their chance to land a spell critical strike.",
      luk: "Quickens how fast a spellcaster's mana returns while resting, out of combat.",
      armor:
  ...
  auraEffect: {
    ...
    increase: {
      ...
      vit: 'Increases Stamina by {value}',
      luk: 'Increases Spirit by {value}',
    ...
    reduce: {
      ...
      vit: 'Reduces Stamina by {value}',
      luk: 'Reduces Spirit by {value}',
