...
export const DICT: Record<string, Record<string, string>> = {
  en: {
    ...
    'world.entered': '{name} has entered Claudenarok Online.',
  ...
  es: {
    ...
    'world.entered': '{name} ha entrado en Claudenarok Online.',
  ...
  fr_FR: {
    ...
    'world.entered': '{name} a rejoint Claudenarok Online.',
  ...
  fr_CA: {
    ...
    'guild.rankOfficer': 'un officier',
    'guild.rankMember': 'un membre',
    'world.entered': '{name} est entré dans Claudenarok Online.',
    'world.left': '{name} a quitté le monde. ({reason})',
    'world.leaveLogout': 'déconnexion',
    'world.leaveDisconnect': 'déconnecté',
  ...
  it_IT: {
    ...
    'world.entered': '{name} è entrato in Claudenarok Online.',
  ...
  de_DE: {
    ...
    'world.entered': '{name} hat Claudenarok Online betreten.',
  ...
  zh_CN: {
    ...
    'guild.rankMember': '会员',
    'world.entered': '{name}进入了Claudenarok Online。',
  ...
  zh_TW: {
    ...
    'guild.rankMember': '成員',
    'world.entered': '{name} 進入了 Claudenarok Online。',
  ...
  ko_KR: {
    ...
    'world.entered': '{name}님이 Claudenarok Online에 입장했습니다.',
  ...
  ja_JP: {
    ...
    'world.entered': '{name}がClaudenarok Onlineに参加しました。',
  ...
  pt_BR: {
    ...
    'world.entered': '{name} entrou em Claudenarok Online.',
  ...
  ru_RU: {
    ...
    'world.entered': '{name} входит в Claudenarok Online.',
...
const RULES: Rule[] = [
  ...
  {
    re: /^(.+) has entered Claudenarok Online\.$/,
