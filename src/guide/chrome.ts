    ...
    <footer class="guide-footer">
      <div class="guide-footer-inner">
        ...
        <nav class="guide-footer-links" aria-label="${esc(t('guide.footer.linksLabel'))}">
          ...
          <a href="https://github.com/idkspvp/claudenarok" target="_blank" rel="noopener">${esc(t('guide.footer.github'))}</a>
          <a href="${DISCORD_INVITE}" target="_blank" rel="noopener">${esc(t('guide.footer.discord'))}</a>
        </nav>
