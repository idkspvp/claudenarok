...
const SPECS: SpecDef[] = [
  ...
  },
  {
    ...
    mastery: { name: 'Recompense', description: 'Increases all threat you generate by 30% and your armor by 10%. Vanguard: your Stamina is increased by 40% and you gain armor equal to 70% of your Strength.', effect: { global: { threatPct: 0.30 }, stats: { armorPct: 0.10, vitPct: 0.40, armorFromStrPct: 0.70 } } },
  },
];
