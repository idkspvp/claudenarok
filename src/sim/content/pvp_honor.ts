...
export const WARFARE_ITEMS: Record<string, ItemDef> = {
  ...
  stormbound_crown: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 265, int: 5, vit: 3, luk: 2 },
    pvpOffenseRating: 17,
    pvpDefenseRating: 17,
    priceHonor: 500,
    sellValue: 0,
  ...
  stormbound_spaulders: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 220, int: 4, vit: 3, luk: 2 },
    pvpOffenseRating: 15,
    pvpDefenseRating: 15,
    priceHonor: 400,
    sellValue: 0,
  ...
  stormbound_hauberk: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 305, int: 6, vit: 4, luk: 2 },
    pvpOffenseRating: 20,
    pvpDefenseRating: 20,
    priceHonor: 700,
    sellValue: 0,
  ...
  stormbound_waistguard: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 200, int: 3, vit: 3, luk: 2 },
    pvpOffenseRating: 14,
    pvpDefenseRating: 14,
    priceHonor: 250,
    sellValue: 0,
  ...
  stormbound_legmail: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 285, int: 5, vit: 4, luk: 2 },
    pvpOffenseRating: 18,
    pvpDefenseRating: 18,
    priceHonor: 600,
    sellValue: 0,
  ...
  stormbound_greaves: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 190, int: 4, vit: 2, luk: 2 },
    pvpOffenseRating: 13,
    pvpDefenseRating: 13,
    priceHonor: 300,
    sellValue: 0,
  ...
  cinderweave_cowl: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 70, int: 5, vit: 3, luk: 2 },
    pvpOffenseRating: 17,
    pvpDefenseRating: 17,
    priceHonor: 500,
    sellValue: 0,
  ...
  cinderweave_mantle: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 50, int: 4, vit: 3, luk: 2 },
    pvpOffenseRating: 15,
    pvpDefenseRating: 15,
    priceHonor: 400,
    sellValue: 0,
  ...
  cinderweave_raiment: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 80, int: 6, vit: 4, luk: 2 },
    pvpOffenseRating: 20,
    pvpDefenseRating: 20,
    priceHonor: 700,
    sellValue: 0,
  ...
  cinderweave_cord: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 45, int: 3, vit: 3, luk: 2 },
    pvpOffenseRating: 14,
    pvpDefenseRating: 14,
    priceHonor: 250,
    sellValue: 0,
  ...
  cinderweave_legwraps: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 65, int: 5, vit: 4, luk: 2 },
    pvpOffenseRating: 18,
    pvpDefenseRating: 18,
    priceHonor: 600,
    sellValue: 0,
  ...
  cinderweave_slippers: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 40, int: 4, vit: 2, luk: 2 },
    pvpOffenseRating: 13,
    pvpDefenseRating: 13,
    priceHonor: 300,
    sellValue: 0,
  ...
  final_argument_greatblade: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    weapon: { min: 96, max: 128, speed: 2.8, weaponType: 'sword', weaponLevel: 3 },
    stats: { str: 5, vit: 7 },
    pvpOffenseRating: 20,
    pvpDefenseRating: 20,
    priceHonor: 800,
  ...
  first_blood_razor: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    weapon: { min: 85, max: 113, speed: 1.7, weaponType: 'dagger', weaponLevel: 3, dagger: true },
    stats: { agi: 5, vit: 7 },
    pvpOffenseRating: 20,
    pvpDefenseRating: 20,
    priceHonor: 800,
  ...
  emberglass_warstaff: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    weapon: { min: 53, max: 71, speed: 3, weaponType: 'rod', weaponLevel: 3 },
    stats: { int: 6, vit: 4, luk: 2 },
    pvpOffenseRating: 20,
    pvpDefenseRating: 20,
    priceHonor: 800,
    sellValue: 0,
