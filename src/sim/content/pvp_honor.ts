...
export const WARFARE_ITEMS: Record<string, ItemDef> = {
  ...
  stormbound_crown: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 5, int: 5, vit: 3, luk: 2 },
    pvpOffenseRating: 17,
    pvpDefenseRating: 17,
    priceHonor: 500,
    sellValue: 0,
  ...
  stormbound_spaulders: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 4, int: 4, vit: 3, luk: 2 },
    pvpOffenseRating: 15,
    pvpDefenseRating: 15,
    priceHonor: 400,
    sellValue: 0,
  ...
  stormbound_hauberk: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 6, int: 6, vit: 4, luk: 2 },
    pvpOffenseRating: 20,
    pvpDefenseRating: 20,
    priceHonor: 700,
    sellValue: 0,
  ...
  stormbound_legmail: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 4, int: 5, vit: 4, luk: 2 },
    pvpOffenseRating: 18,
    pvpDefenseRating: 18,
    priceHonor: 600,
    sellValue: 0,
  ...
  stormbound_greaves: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 5, int: 4, vit: 2, luk: 2 },
    pvpOffenseRating: 13,
    pvpDefenseRating: 13,
    priceHonor: 300,
    sellValue: 0,
  ...
  cinderweave_cowl: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 4, int: 5, vit: 3, luk: 2 },
    pvpOffenseRating: 17,
    pvpDefenseRating: 17,
    priceHonor: 500,
    sellValue: 0,
  ...
  cinderweave_mantle: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 3, int: 4, vit: 3, luk: 2 },
    pvpOffenseRating: 15,
    pvpDefenseRating: 15,
    priceHonor: 400,
    sellValue: 0,
  ...
  cinderweave_raiment: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 4, int: 6, vit: 4, luk: 2 },
    pvpOffenseRating: 20,
    pvpDefenseRating: 20,
    priceHonor: 700,
    sellValue: 0,
  ...
  cinderweave_legwraps: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 3, int: 5, vit: 4, luk: 2 },
    pvpOffenseRating: 18,
    pvpDefenseRating: 18,
    priceHonor: 600,
    sellValue: 0,
  ...
  cinderweave_slippers: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 3, int: 4, vit: 2, luk: 2 },
    pvpOffenseRating: 13,
    pvpDefenseRating: 13,
    priceHonor: 300,
    sellValue: 0,
