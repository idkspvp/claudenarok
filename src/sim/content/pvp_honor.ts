...
export const WARFARE_ITEMS: Record<string, ItemDef> = {
  ...
  cinderweave_raiment: {
    ...
    cardSlots: 1,
    requiredLevel: 20,
    stats: { mdef: 2, armor: 4, int: 3, vit: 2 },
    pvpOffenseRating: 20,
    pvpDefenseRating: 20,
    priceHonor: 700,
    sellValue: 0,
