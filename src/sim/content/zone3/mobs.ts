...
export const ZONE3_MOBS: Record<string, MobTemplate> = {
  ...
  ridge_stalker: {
    ...
    elementLevel: 1,
    size: 'medium',
    // Boa, level 15 in the reference table.
    hp: 471,
    atk: 46,
    atk2: 55,
    def: 0,
  ...
  thornpeak_ogre: {
    ...
    elementLevel: 1,
    size: 'large',
    // Muka, level 17 in the reference table.
    hp: 610,
    atk: 40,
    atk2: 49,
    def: 5,
  ...
  stormcrag_elemental: {
    ...
    elementLevel: 1,
    size: 'large',
    // Steel, level 17 in the reference table.
    hp: 530,
    atk: 54,
    atk2: 65,
    def: 15,
  ...
  wyrmcult_zealot: {
    ...
    elementLevel: 1,
    size: 'medium',
    // Thief, level 19 in the reference table.
    hp: 583,
    atk: 76,
    atk2: 88,
    def: 15,
  ...
  fallen_captain_aldren: {
    ...
    elementLevel: 2,
    size: 'medium',
    // Elder, level 20 in the reference table.
    def: 10,
    mdef: 30,
    baseExp: 163,
    jobExp: 101,
  ...
  marrowlord_varkas: {
    ...
    elementLevel: 2,
    size: 'large',
    // Peco, level 19 in the reference table.
    def: 0,
    mdef: 0,
    baseExp: 159,
    jobExp: 72,
