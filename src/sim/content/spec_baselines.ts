...
export const SPEC_BASELINES: SpecBaselineTable = {
  paladin: {
    ...
    protection: {
      // vitPct 0.35 (2026-07 tank parity): armor was already best-in-class,
      ...
      stats: { str: 6, dodge: 0.02, armorPct: 0.29, vitPct: 0.35 },
