...
export const ZONE2_ITEMS: Record<string, ItemDef> = {
  ...
  voss_sanctified_mace: {
    ...
    quality: 'uncommon',
    cardSlots: 1,
    weapon: { min: 65, max: 86, speed: 2.6, weaponType: 'mace', weaponLevel: 2, element: 'holy' },
    stats: { int: 3, luk: 2 },
    sellValue: 420,
    requiredClass: MAG,
  },
  ...
  drowned_tide_scepter: {
    ...
    quality: 'rare',
    cardSlots: 1,
    weapon: { min: 35, max: 47, speed: 3.0, weaponType: 'rod', weaponLevel: 2, element: 'water' },
    stats: { int: 6, luk: 3 },
    sellValue: 1400,
    requiredClass: MAG,
  },
