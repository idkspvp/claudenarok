...
export const ZONE2_MOBS: Record<string, MobTemplate> = {
  mire_prowler: {
    ...
    elementLevel: 1,
    size: 'medium',
    // Familiar, level 8 in the reference table.
    hp: 155,
    atk: 20,
    atk2: 28,
    def: 0,
  ...
  deepfen_murloc: {
    ...
    elementLevel: 1,
    size: 'medium',
    // Rocker, level 9 in the reference table.
    hp: 198,
    atk: 24,
    atk2: 29,
    def: 5,
  ...
  fen_troll: {
    ...
    elementLevel: 1,
    size: 'large',
    // Mandragora, level 12 in the reference table.
    hp: 405,
    atk: 26,
    atk2: 35,
    def: 0,
  ...
  gravecaller_cultist: {
    ...
    elementLevel: 1,
    size: 'medium',
    // Tarou, level 11 in the reference table.
    hp: 284,
    atk: 34,
    atk2: 45,
    def: 0,
  ...
  bog_bloat: {
    ...
    elementLevel: 1,
    size: 'large',
    // Baby, level 9 in the reference table.
    hp: 164,
    atk: 30,
    atk2: 36,
    def: 0,
