...
export const TEMPLE_ITEMS: Record<string, ItemDef> = {
  ...
  moonscale_saber: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 69, max: 92, speed: 2.4, weaponType: 'sword', weaponLevel: 2 },
    stats: { str: 5, vit: 2 },
    sellValue: 700,
    requiredClass: WAR,
  },
  ...
  tideglass_dirk: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 59, max: 78, speed: 1.7, weaponType: 'dagger', weaponLevel: 2, dagger: true },
    stats: { agi: 6 },
    sellValue: 700,
    requiredClass: ROG,
  },
  ...
  drownedmoon_scepter: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 45, max: 60, speed: 3.0, weaponType: 'rod', weaponLevel: 3 },
    stats: { int: 10, luk: 4 },
    sellValue: 2200,
    requiredClass: MAG,
  },
  drownedmoon_kris: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 73, max: 97, speed: 1.7, weaponType: 'dagger', weaponLevel: 3, dagger: true },
    stats: { agi: 9, vit: 3 },
    sellValue: 2200,
    requiredClass: ROG,
  },
