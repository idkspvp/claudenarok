...
export const TEMPLE_MOBS: Record<string, MobTemplate> = {
  glimmermere_wader: {
    ...
    elementLevel: 1,
    size: 'medium',
    // Spore, level 16 in the reference table.
    hp: 510,
    atk: 24,
    atk2: 48,
    def: 0,
...
export const TEMPLE_DUNGEON_MOBS: Record<string, MobTemplate> = {
  ...
  pearlguard_sentinel: {
    ...
    elementLevel: 2,
    size: 'large',
    // Smokie, level 18 in the reference table.
    hp: 641,
    atk: 61,
    atk2: 72,
    def: 0,
  ...
  choirmother_selthe: {
    ...
    elementLevel: 2,
    size: 'medium',
    // Vocal, level 18 in the reference table.
    hp: 3016,
    atk: 71,
    atk2: 82,
    def: 10,
  ...
  moonspawn: {
    ...
    elementLevel: 1,
    size: 'small',
    // Shellfish, level 15 in the reference table.
    def: 35,
    mdef: 0,
    baseExp: 66,
    jobExp: 44,
