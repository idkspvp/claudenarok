...
export const BASE_ITEMS: Record<string, ItemDef> = {
  ...
  worn_sword: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 41, max: 54, speed: 2.0, weaponType: 'sword', weaponLevel: 1 },
    sellValue: 10,
  },
  gnarled_staff: {
    id: 'gnarled_staff',
  ...
  rusty_dagger: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 31, max: 41, speed: 1.8, weaponType: 'dagger', weaponLevel: 1, dagger: true },
    sellValue: 10,
  },
  training_mace: {
    id: 'training_mace',
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 41, max: 54, speed: 2.6, weaponType: 'mace', weaponLevel: 1 },
    sellValue: 10,
  },
  rusty_hatchet: {
    id: 'rusty_hatchet',
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 38, max: 50, speed: 2.2, weaponType: 'axe', weaponLevel: 1 },
    sellValue: 10,
  },
  recruit_tunic: {
    id: 'recruit_tunic',
  ...
  redbrook_blade: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 48, max: 64, speed: 2.2, weaponType: 'sword', weaponLevel: 1 },
    stats: { str: 2 },
    sellValue: 120,
    requiredClass: WAR,
  },
  apprentice_staff: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 25, max: 33, speed: 3.0, weaponType: 'rod', weaponLevel: 1 },
    stats: { int: 3, vit: 1 },
    sellValue: 120,
  ...
  keen_dirk: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 39, max: 52, speed: 1.7, weaponType: 'dagger', weaponLevel: 1, dagger: true },
    stats: { agi: 2 },
    sellValue: 120,
    requiredClass: ROG,
  },
  ...
  bristleback_maul: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 52, max: 69, speed: 2.8, weaponType: 'mace', weaponLevel: 1 },
    stats: { str: 2, vit: 1 },
    sellValue: 160,
    requiredClass: WAR,
  },
  ...
  gorraks_cruel_chopper: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 51, max: 68, speed: 2.4, weaponType: 'axe', weaponLevel: 1 },
    stats: { str: 2, vit: 1 },
    sellValue: 180,
    requiredClass: WAR,
  },
  tunnelkings_spade: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 41, max: 54, speed: 2.7, weaponType: 'spear', weaponLevel: 1 },
    stats: { str: 3, vit: 2 },
    sellValue: 190,
    requiredClass: WAR,
  },
  ...
  moggers_copper_cudgel: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 57, max: 76, speed: 2.6, weaponType: 'mace', weaponLevel: 1 },
    stats: { str: 3, vit: 2 },
    sellValue: 850,
    requiredClass: WAR,
  },
  moggers_shiv: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 45, max: 60, speed: 1.7, weaponType: 'dagger', weaponLevel: 1, dagger: true },
    stats: { agi: 4, vit: 2 },
    sellValue: 850,
    requiredClass: ROG,
  },
  valeborn_spellblade: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 52, max: 69, speed: 2.2, weaponType: 'sword', weaponLevel: 1 },
    stats: { int: 4, luk: 2 },
    sellValue: 850,
    requiredClass: MAG,
  },
  ...
  eastbrook_arming_sword: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 46, max: 61, speed: 2.2, weaponType: 'sword', weaponLevel: 1 },
    sellValue: 140,
    buyValue: 1400,
  },
  eastbrook_greatsword: {
    ...
    hand: 'twohand',
    quality: 'common',
    weapon: { min: 54, max: 72, speed: 3.4, weaponType: 'twohand_sword', weaponLevel: 1 },
    sellValue: 160,
    buyValue: 1600,
  },
  bronzework_mace: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 49, max: 65, speed: 2.6, weaponType: 'mace', weaponLevel: 1 },
    sellValue: 140,
    buyValue: 1400,
  },
  vale_carving_knife: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 37, max: 49, speed: 1.8, weaponType: 'dagger', weaponLevel: 1, dagger: true },
    sellValue: 120,
    buyValue: 1200,
  },
  hickory_shortstaff: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 24, max: 32, speed: 3.0, weaponType: 'rod', weaponLevel: 1 },
    stats: { int: 1 },
    sellValue: 150,
    buyValue: 1500,
  },
  ...
  gravecaller_blade: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 54, max: 72, speed: 2.4, weaponType: 'sword', weaponLevel: 1 },
    stats: { str: 4, vit: 3 },
    sellValue: 800,
  },
  widowfang_dirk: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 43, max: 57, speed: 1.7, weaponType: 'dagger', weaponLevel: 1, dagger: true },
    stats: { agi: 4, vit: 3 },
    sellValue: 800,
  },
  gravecaller_staff: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 28, max: 37, speed: 3.0, weaponType: 'rod', weaponLevel: 1 },
    stats: { int: 5, luk: 2 },
    sellValue: 800,
  },
  marrowtread_boots: {
  ...
  verlans_oathblade: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 54, max: 72, speed: 2.5, weaponType: 'sword', weaponLevel: 1 },
    stats: { str: 4, vit: 2 },
    sellValue: 880,
    requiredClass: WAR,
  },
  hollow_vigil_staff: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 29, max: 38, speed: 3.0, weaponType: 'rod', weaponLevel: 1 },
    stats: { int: 5, luk: 2 },
    sellValue: 880,
    requiredClass: CASTER_WEAPON_CLASSES,
  },
  ...
  briarroot_staff: {
    ...
    weapon: { min: 41, max: 54, speed: 3.3, weaponType: 'twohand_rod', weaponLevel: 1 },
    stats: { str: 2, vit: 2 },
    sellValue: 320,
    requiredClass: FERAL,
  },
  ...
  monarch_crown_helm: {
    ...
    slot: 'helmet',
    quality: 'rare',
    stats: { armor: 3, vit: 3, agi: 2, str: 1 },
    sellValue: 320,
  },
  // --- junk (gray) ---
  ...
  gorraks_cleaver: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 53, max: 70, speed: 2.5, weaponType: 'axe', weaponLevel: 1 },
    stats: { str: 3 },
    sellValue: 180,
    requiredClass: WAR,
  },
  ...
  crossroads_saber: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 52, max: 69, speed: 2.5, weaponType: 'sword', weaponLevel: 1 },
    stats: { str: 2 },
    sellValue: 170,
  },
  tradesman_hatchet: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 51, max: 68, speed: 2.3, weaponType: 'axe', weaponLevel: 1 },
    stats: { str: 1, vit: 1 },
    sellValue: 160,
  },
  drovers_staff: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 26, max: 35, speed: 3.0, weaponType: 'rod', weaponLevel: 1 },
    stats: { int: 3, luk: 2 },
    sellValue: 175,
    requiredClass: CASTER_WEAPON_CLASSES,
  },
  caravan_warden_dirk: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 41, max: 54, speed: 1.7, weaponType: 'dagger', weaponLevel: 1, dagger: true },
    stats: { agi: 3 },
    sellValue: 170,
    requiredClass: ROG,
  },
