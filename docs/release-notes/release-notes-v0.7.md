# Claudenarok Online, v0.7 Release Notes
...
- **Chroma / skin selection** (#403), a 1 to 4 chroma picker in online character
...
A large family of commands that report your own state without affecting the world, useful for accessibility, theory-crafting, and headless/RL inspection:
...
- **Canonical brand casing**, standardized on **"Claudenarok Online"** across UI,
