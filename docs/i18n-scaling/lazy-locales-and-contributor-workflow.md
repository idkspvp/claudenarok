...
Claudenarok Online is six days old. Content is being added daily: new zones, dungeons, abilities, items, talents, and the player-visible strings that come with them. Every one of those strings is a `t()` key, and the i18n system is on the critical path of both the bundle and the contributor workflow.
...
### 5.1 Root `/Users/fernando/Documents/claudenarok/CLAUDE.md`
...
### 5.2 `/Users/fernando/Documents/claudenarok/src/ui/CLAUDE.md`
...
### 5.3 `/Users/fernando/Documents/claudenarok/src/admin/CLAUDE.md`
...
### 5.4 `/Users/fernando/Documents/claudenarok/docs/i18n-scaling/translation-workflow.md` (ALREADY CREATED)
...
- `/Users/fernando/Documents/claudenarok/scripts/i18n_build.mjs` (Step 1 emit + `I18N_OUT_DIR`)
- `/Users/fernando/Documents/claudenarok/scripts/i18n_admin_build.mjs` (Step 1 admin)
- `/Users/fernando/Documents/claudenarok/scripts/i18n_scan.mjs` (Step 4 `I18N_OUT_DIR`, optional summary)
- `/Users/fernando/Documents/claudenarok/scripts/i18n_resolved_hash.mjs` (Step 3 Option 3b only) (2026-07-14, D4: now a print-only diagnostic; the committed baseline is deleted)
- `/Users/fernando/Documents/claudenarok/src/ui/i18n.ts` (Steps 2-3 loader + flip)
- `/Users/fernando/Documents/claudenarok/src/main.ts` (Step 2 bootstrap await before `mountGameUi`; picker `switchLanguage`)
- `/Users/fernando/Documents/claudenarok/src/admin/i18n.ts` and `/Users/fernando/Documents/claudenarok/src/admin/main.ts` (admin parity)
- `/Users/fernando/Documents/claudenarok/tests/homepage_foundation.test.ts` (Step 3: `await ensureLocaleLoaded` before each non-en `t()` assertion)
- `/Users/fernando/Documents/claudenarok/tests/i18n_t_behavior.test.ts` (Step 3: re-point the pending-injection mock to `LOCALE_LOADERS` / `resident`; add sync-`t()` and loader-rejection cases)
- `/Users/fernando/Documents/claudenarok/tests/i18n_resolved_equivalence.test.ts`, `/Users/fernando/Documents/claudenarok/tests/i18n_status_registry.test.ts` (Step 4 gates; 3b also repoints the latter's `../src/ui/i18n` import)
- `/Users/fernando/Documents/claudenarok/tests/localization_fixes.test.ts` (the S3 guard; no logic change, now depends on `pretest` for `status.json`; under 3b repoint its 14-const import)
- `/Users/fernando/Documents/claudenarok/tests/helpers/i18n_determinism.ts` (new)
- `/Users/fernando/Documents/claudenarok/.gitignore` (Step 4 `status.json`)
- `/Users/fernando/Documents/claudenarok/.github/workflows/ci.yml` (Step 4 `i18n:gen` step)
- `/Users/fernando/Documents/claudenarok/package.json` (Step 4 `i18n:gen` script)
- `/Users/fernando/Documents/claudenarok/CLAUDE.md`, `/Users/fernando/Documents/claudenarok/src/ui/CLAUDE.md`, `/Users/fernando/Documents/claudenarok/src/admin/CLAUDE.md` (Step 5 policy)
- `/Users/fernando/Documents/claudenarok/docs/i18n-scaling/translation-workflow.md` (Step 5, new)
