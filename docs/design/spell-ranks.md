...
| thunder_clap | 1 | 6 | 20 | inst | aoe 12 to 14 r8 + atkspeed 1.1/10s |
| | **2** | **14** | 20 | inst | aoe **23 to 27** r8 + same rider |
| | **3** | **20** | 20 | inst | aoe **37 to 43** r8 + same rider |
...
|---|---|---|---|---|
| `execute` | 14 | 15 | inst | `requiresTargetHpBelow: 0.2`, directDamage 60 to 75 |
...
| Ability | Rank | Learn | Cost | Cast | Effect values |
|---|---|---|---|---|---|
| fireball | 1 | 1 | 30 | 1.5 | 16 to 25 + dot 2/4s |
| | 2 | 6 | 45 | 2.0 | 22 to 31 + dot 3/6s *(exists)* |
| | **3** | **12** | 65 | **2.5** | **36 to 48** + dot 6/6s (3×2) |
| | **4** | **18** | 95 | **3.0** | **58 to 78** + dot 12/8s (4×3) |
| frostbolt | 1 | 4 | 25 | 1.5 | 18 to 20 + slow 0.6/5s |
| | 2 | 8 | 35 | 2.0 | 31 to 35 + slow 0.6/6s *(exists)* |
| | **3** | **14** | 50 | **2.5** | **44 to 50** + slow 0.6/7s |
| | **4** | **20** | 70 | 2.5 | **66 to 74** + slow 0.6/9s |
| fire_blast | 1 | 6 | 40 | inst, 8cd | 27 to 35 |
| | **2** | **12** | 60 | inst, 8cd | **44 to 54** |
| | **3** | **18** | 85 | inst, 8cd | **68 to 82** |
...
| | **2** | **18** | 70 | 1.5 | **20s** |
| frost_nova | 1 | 10 | 35 | inst, 22cd | aoeRoot 8s r10, 6 to 7 |
| | **2** | **16** | 50 | inst, 22cd | aoeRoot 8s r10, **12 to 14** |

**NEW:**

| Ability | Learn | Cost | Cast/CD | Effects |
|---|---|---|---|---|
| `arcane_explosion` | 14 | 60 | inst | aoeDamage 26 to 31, radius 10 (caster-centered) |
| `scorch` | 16 | 35 | 1.5s | directDamage 32 to 40 (fast fire filler) |
...
| | **2** | **12** | 35 | base **8**, perCombo **12**, var 6 (5cp ≈ 62 to 74) |
| | **3** | **18** | 35 | base **14**, perCombo **18**, var 9 (5cp ≈ 95 to 113) |
| backstab | 1 | 4 | 60 | weaponMult 1.5, +11 (behind, dagger) |
| | **2** | **12** | 60 | weaponMult 1.5, **+20** |
| | **3** | **18** | 60 | weaponMult 1.5, **+32** |
| gouge | 1 | 6 | 45 | 8 to 9 dmg + incapacitate 4s |
| | **2** | **14** | 45 | **15 to 17** dmg + incapacitate 4s |
...
|---|---|---|---|---|
| `kidney_shot` | 14 | 25 | 20s | spendsCombo, **finisherStun { base 1, perCombo 1 }** (2 to 6s), *the one new effect type* |
...
| Ability | Rank | Learn | Cost | Cast | Effect values |
|---|---|---|---|---|---|
| seal_of_righteousness | 1 | 1 | 25 | inst | imbue +4/swing, judge 10 to 18 |
| | **2** | **10** | 35 | inst | imbue **+7**, judge **18 to 28** |
| | **3** | **16** | 50 | inst | imbue **+11**, judge **30 to 44** |
| holy_light | 1 | 1 | 35 | 2.5 | heal 42 to 51 |
| | **2** | **8** | 60 | 2.5 | heal **76 to 90** |
| | **3** | **14** | 95 | 2.5 | heal **122 to 144** |
| | **4** | **20** | 140 | 2.5 | heal **190 to 222** |
...
| Ability | Learn | Cost | Cast/CD | Effects |
|---|---|---|---|---|
| `flash_of_light` | 12 | 35 | 1.5s | heal 62 to 76 (efficient fast heal) |
...
| arcane_shot | 1 | 6 | 25 | 13 to 17 (6cd) |
| | **2** | **12** | 40 | **24 to 30** |
| | **3** | **18** | 55 | **38 to 47** |
...
| Ability | Rank | Learn | Cost | Cast | Effect values |
|---|---|---|---|---|---|
| smite | 1 | 1 | 20 | 2.0 | 15 to 20 |
| | **2** | **8** | 32 | 2.0 | **26 to 33** |
| | **3** | **14** | 48 | **2.5** | **42 to 52** |
| | **4** | **20** | 70 | 2.5 | **64 to 78** |
| lesser_heal | 1 | 1 | 30 | 2.0 | heal 47 to 58 |
| | **2** | **6** | 45 | 2.0 | heal **72 to 86** |
| | **3** | **12** | 65 | 2.0 | heal **110 to 132** |
...
| mind_blast | 1 | 10 | 50 | 1.5, 8cd | 42 to 46 |
| | **2** | **14** | 70 | 1.5, 8cd | **60 to 66** |
| | **3** | **20** | 95 | 1.5, 8cd | **86 to 94** |

**NEW:**

| Ability | Learn | Cost | Cast/CD | Effects |
|---|---|---|---|---|
| `heal` | 14 | 95 | 2.5s | heal 165 to 195; **R2 @ L20**: cost 130, heal 230 to 270 |
...
| Ability | Rank | Learn | Cost | Cast | Effect values |
|---|---|---|---|---|---|
| lightning_bolt | 1 | 1 | 15 | 1.5 | 15 to 17 |
| | **2** | **8** | 25 | **2.0** | **26 to 30** |
| | **3** | **14** | 40 | **2.5** | **45 to 51** |
| | **4** | **20** | 60 | **3.0** | **75 to 85** |
| rockbiter_weapon | 1 | 1 | 20 | inst | imbue +5/swing, 5min |
| | **2** | **8** | 30 | inst | imbue **+9** |
| | **3** | **16** | 45 | inst | imbue **+14** |
| healing_wave | 1 | 1 | 25 | 1.5 | heal 36 to 44 |
| | **2** | **6** | 40 | **2.0** | heal **56 to 68** |
| | **3** | **12** | 65 | **2.5** | heal **92 to 110** |
| | **4** | **18** | 90 | 2.5 | heal **138 to 164** |
| earth_shock | 1 | 4 | 30 | inst, 6cd | 19 to 22 |
| | **2** | **10** | 45 | inst, 6cd | **33 to 38** |
| | **3** | **16** | 65 | inst, 6cd | **54 to 61** |
...
| `frost_shock` | 14 | 50 | inst, 6cd, 20yd | directDamage 36 to 42 + slow 0.5/8s |
...
| Ability | Rank | Learn | Cost | Cast | Effect values |
|---|---|---|---|---|---|
| shadow_bolt | 1 | 1 | 25 | 1.7 | 13 to 18 |
| | **2** | **8** | 38 | **2.2** | **24 to 31** |
| | **3** | **14** | 55 | **2.7** | **42 to 53** |
| | **4** | **20** | 80 | **3.0** | **68 to 84** |
...
| Ability | Rank | Learn | Cost | Cast | Effect values |
|---|---|---|---|---|---|
| wrath | 1 | 1 | 20 | 1.5 | 13 to 16 |
| | **2** | **8** | 32 | **2.0** | **24 to 29** |
| | **3** | **14** | 48 | 2.0 | **38 to 45** |
| | **4** | **20** | 70 | 2.0 | **60 to 71** |
| healing_touch | 1 | 1 | 25 | 2.5 | heal 37 to 51 |
| | **2** | **8** | 45 | **3.0** | heal **68 to 86** |
| | **3** | **14** | 75 | 3.0 | heal **115 to 140** |
| | **4** | **20** | 110 | 3.0 | heal **175 to 208** |
| moonfire | 1 | 4 | 25 | inst | 9 to 12 + dot 12/9s |
| | **2** | **10** | 40 | inst | **17 to 21** + dot **24/12s** (4×6) |
| | **3** | **16** | 60 | inst | **28 to 34** + dot **40/12s** (4×10) |
...
| Ability | Learn | Cost | Cast/CD | Effects |
|---|---|---|---|---|
| `regrowth` | 14 | 55 | 2.0s | heal 52 to 62 + hot 49/21s (7×7), combo heal+HoT, both existing types |
| `barkskin` | 16 | 30 | inst, 60cd, offGcd | selfBuff buff_armor +150, 15s |
| `starfire` | 18 | 80 | 3.0s | directDamage 60 to 74 |
...
## Cross-class summary of new abilities (10 to 20 band)
...
Files to touch when implementing: `/Users/reubenhorne/Documents/code/idkspvp/claudenarok/src/sim/data.ts` (ABILITIES ranks + new entries, CLASSES.abilities arrays, 2 conjured-water items), `/Users/reubenhorne/Documents/code/idkspvp/claudenarok/src/sim/types.ts` (one new AbilityEffect variant `finisherStun`, XP_TABLE/MAX_LEVEL extension per the brief).
