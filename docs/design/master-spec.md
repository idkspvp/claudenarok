# FINAL MASTER DESIGN SPEC, Claudenarok Online Expansion (Levels 6 to 20)

Synthesized directly from the WORLD_BRIEF and the three judge verdicts (no designer text survived; this document IS the design). All XP math recomputed against `src/sim/types.ts` (`XP_TABLE`, `mobXpValue`, `zeroDiff`, `GROUP_XP_BONUS`): XP 6→13 = 46,500; 13→20 = 113,100; kill XP = 45+5×mobLevel at level; elite ×2; dungeon per-member XP = mobXp × 2 × 1.43 / 5 = 0.572× solo (dungeons are loot/story events, NOT XP soaks); 1.6× overshoot applied to quest-required kills only. All ids snake_case, collision-checked against `src/sim/data.ts` @ 2d05cc2. Companion specs (ability ranks 1 to 20, procedural icons, graphics tiers) already exist in `wf_0c329a02-def/journal.jsonl`, referenced in §7, not regenerated.
...
- **Act I, Eastbrook Vale (1 to 10, exists + enhancements).** The dead won't rest. Players uncover the Gravecaller sigil, perform the Binding Rite, and kill Morthen the Gravecaller in the Hollow Crypt. NEW build-up quests (below) establish that Morthen was raising the chapel's own buried congregation, and his correspondence reveals he answered to a master in the marsh.
- **Act II, Mirefen Marsh (6 to 13).** Morthen was only an acolyte. The cult's **Vael the Mistcaller** is drowning travelers in the fen and raising them as an army, the Drowned Dead. The marsh trolls dug too deep into old burial mounds and woke things; the murlocs are dredging up cult idols from the lakebed. The chain runs: muster at Fenbridge → trace the idols → the Drowned Chapel → break the cult camp → kill Deacon Voss → storm **The Sunken Bastion** (5-player, L13) and kill Vael. His final words name the true master: *"The Wyrm stirs beneath the peaks."*
- **Act III, Thornpeak Heights (13 to 20).** The Gravecallers serve **Korzul the Gravewyrm**, an ancient dragon the sect has spent generations trying to wake, every raised corpse in the Vale and the fen was a tithe of souls. The ogre clans have been bought as muscle (Warlord Drogmar), elementals shake loose from the mountain as the Wyrm turns in its sleep, and the Wyrmcult openly chants at the **Gravewyrm Sanctum** gates. The finale: a solo-able lead-up chain (18 to 19) breaks the seal, then a 5-player dungeon kills Grand Necromancer Velkhar, Korgath the Bound, and finally Korzul at level 20.

## Hollow Crypt build-up quests (zone 1 additions, L7 to 9)

Four new quests make the crypt "riveting" using only existing engine patterns (ground sparkles per the `gravecaller_sigil` precedent, staged kill chains, in-instance kill quest). These also patch the 7 to 9 solo soft gap.
...
# 2. Zone 2 spec, Mirefen Marsh (levels 6 to 13)
...
**Roads:** Eastbrook→Fenbridge: (0,80)→(0,180)→(-8,240)→(0,300). Fenbridge spokes: →(50,380)→(90,420) [Drowned Chapel]; →(-40,370)→(-80,420) [Troll Mounds]; →(10,400)→(20,470)→(45,515) [cult camp → Bastion]. Camps sit 40 to 90 yd off-road.
...
|---|---|---|---|---|---|---|---|---|
| mire_prowler | Mire Prowler | beast | 7 to 8 |, | 46/19 | 7/2.1 | 2.0 | copper 30; mire_prowler_pelt 0.6 (q_prowler_pelts); soggy_moccasin 0.3 |
| deepfen_murloc | Deepfen Snapper | murloc | 8 to 9 |, | 48/19 | 7/2.2 | 1.9 | aggro 14, social; copper 35; waterlogged_idol 0.5 (q_idols); mudfin_scale 0.4 |
| mire_widow | Mirefen Widow | spider | 8 to 10 |, | 48/19 | 8/2.2 | 1.8 | copper 38; widow_venom_sac 0.65 (q_widows); spider_leg 0.4 |
| mirefen_broodmother | The Broodmother | spider | 10 | boss | 150/26 | 9/2.4 | 1.8 | scale 1.4; copper 300; marshstrider_boots 0.4 |
| drowned_dead | Drowned Dead | undead | 9 to 11 |, | 52/20 | 8/2.3 | 2.3 | copper 42; bone_fragments 0.5; cracked_fetish 0.3 |
| fen_troll | Mirefen Troll | **troll** (new) | 10 to 12 |, | 56/21 | 9/2.4 | 2.2 | copper 50; troll_fetish 0.6 (q_troll_fetishes); chipped_tusk 0.4 |
| grubjaw | Grubjaw the Glutton | troll | 12 | rare | 130/26 | 10/2.5 | 2.2 | Old Greyjaw pattern; grubjaw_tusk 1.0 (q_grubjaw); copper 200 |
| gravecaller_cultist | Gravecaller Cultist | humanoid | 10 to 12 |, | 50/20 | 9/2.4 | 2.0 | copper 55; linen_scrap 0.3; tallow_candle 0.3 |
| gravecaller_summoner | Gravecaller Summoner | humanoid | 11 to 12 |, | 46/19 | 10/2.5 | 2.0 | copper 60; cult_cipher 0.6 (q_summoners) |
...
| bastion_revenant | Bastion Revenant | undead | 12 to 13 | elite | 54/21 | 9/2.4 | 2.3 | copper 150; bone_fragments 0.7 |
| tidebound_acolyte | Tidebound Acolyte | humanoid | 12 to 13 | elite | 50/20 | 10/2.5 | 2.0 | copper 170; linen_scrap 0.5 |
...
# 3. Zone 3 spec, Thornpeak Heights (levels 13 to 20)
...
| id | name | family | lvl | flags | hpBase/perLvl | dmgBase/perLvl | atkSpd | notes / loot highlights |
|---|---|---|---|---|---|---|---|---|
| ridge_stalker | Ridge Stalker | beast | 13 to 14 |, | 58/21 | 10/2.5 | 1.9 | copper 60; ridge_stalker_pelt 0.6 (q_stalker_pelts) |
| deeprock_kobold | Deeprock Tunneler | kobold | 14 to 15 |, | 60/22 | 10/2.5 | 2.1 | copper 65; glowing_wax 0.5 (q_glowing_wax); tallow_candle 0.4 |
| thornpeak_ogre | Thornpeak Ogre | **ogre** (new) | 15 to 16 |, | 66/23 | 11/2.6 | 2.6 | scale 1.3; copper 75; ogre_toe_ring 0.35 |
| ogre_crusher | Thornpeak Crusher | ogre | 16 to 17 | elite | 64/23 | 11/2.6 | 2.6 | copper 200; ogre_toe_ring 0.5 |
| warlord_drogmar | Warlord Drogmar | ogre | 17 | elite, boss | 200/30 | 12/2.7 | 2.6 | aoePulse {22,30,r10,every12,'Ground Slam'}; copper 2000 |
| stormcrag_elemental | Stormcrag Elemental | **elemental** (new) | 17 to 18 |, | 62/22 | 12/2.7 | 2.2 | copper 80; storm_core 0.55 (q_shard_cores); blessed_embers 0.55 (q_breaking_the_seal); inert_storm_shard 0.4 |
| shardlord_kazzix | Shardlord Kazzix | elemental | 18 | rare | 160/28 | 13/2.8 | 2.2 | kazzix_heartshard 1.0 (q_kazzix); copper 500 |
| wyrmcult_zealot | Wyrmcult Zealot | humanoid | 17 to 19 |, | 62/22 | 12/2.7 | 2.0 | copper 90; wyrmcult_orders 0.5 (q_cult_orders); frayed_prayer_beads 0.35 |
| wyrmcult_necromancer | Wyrmcult Necromancer | humanoid | 18 to 19 |, | 58/21 | 13/2.8 | 2.0 | copper 100; ritual_phylactery 0.55 (q_necromancers) |
| boneclad_revenant | Boneclad Revenant | undead | 18 to 19 |, | 66/23 | 12/2.7 | 2.3 | copper 100; bone_fragments 0.6 |
| sanctum_boneguard | Sanctum Boneguard | undead | 19 | elite | 64/23 | 12/2.7 | 2.3 | copper 300 |
| sanctum_drakonid | Sanctum Drakonid | **dragonkin** (new, reuses boss rig scaled 0.8) | 19 to 20 | elite | 68/24 | 13/2.8 | 2.2 | copper 350; cracked_wyrm_scale 0.5 |
...
**Layout (linear, 3 chambers, z 0→150):** Chamber 1 "The Boneworks" (z 10 to 60, boneguard/drakonid packs) → Korgath's Hall (z 60 to 75) → Chamber 2 "The Ritual Vault" (z 75 to 115, Velkhar) → Chamber 3 "The Wyrm's Hollow" (z 115 to 150, Korzul on a raised dais ringed by drakonid guards).
...
| Extras (not counted in core) | Bastion clear ≈ 850/member; group-elite kills ≈ 300; grind | pushes ~+14 to 15% |
...
19→20 (21,300) funding: lead-up chain 16,200 (solo, 17 to 25% of level each) + dungeon quests 14,000 + revenant arc spillover, comfortably covered without treating dungeon trash as a soak.

## Band coverage guardrail (every level has at-level mobs; gray cutoff zeroDiff 7 @ L10 to 15, 8 @ L16+)

| player level | at-level mobs |
|---|---|
| 6 to 8 | mire_prowler (7 to 8), deepfen_murloc (8 to 9) |
| 8 to 10 | mire_widow (8 to 10), drowned_dead (9 to 11) |
| 10 to 12 | fen_troll (10 to 12), gravecaller_cultist/summoner (10 to 12) |
| 12 to 13 | deacon_voss (12), Bastion elites (12 to 13), grubjaw (12) |
| 13 to 15 | ridge_stalker (13 to 14), deeprock_kobold (14 to 15) |
| 15 to 17 | thornpeak_ogre (15 to 16), ogre_crusher (16 to 17 elite) |
| 17 to 19 | stormcrag_elemental (17 to 18), wyrmcult_zealot (17 to 19), necromancer/revenant (18 to 19) |
| 19 to 20 | Sanctum elites (19 to 20), kazzix (18 rare) |
...
|---|---|---|---|---|---|---|
| deacons_cleaver | Deacon's Cleaver | weapon/mainhand | uncommon | 11 to 18 spd 2.4, str 4 | 300 | warrior |
| staff_of_drowned_prayers | Staff of Drowned Prayers | weapon/mainhand | uncommon | 12 to 20 spd 3.0, int 5 spi 2 | 300 | mage |
| mistbinder_kris | Mistbinder Kris | weapon/mainhand | uncommon | 7 to 12 spd 1.7 dagger, agi 4 | 300 | rogue |
...
| mistcallers_edge | Mistcaller's Edge | weapon/mainhand | rare | 14 to 23 spd 2.3, str 4 sta 3 | 1200 | warrior |
| vaels_mist_staff | Vael's Mist-Staff | weapon/mainhand | rare | 15 to 26 spd 3.0, int 6 spi 3 | 1200 | mage |
| riptide_dirk | Riptide Dirk | weapon/mainhand | rare | 9 to 15 spd 1.7 dagger, agi 5 sta 2 | 1200 | rogue |
...
| zealotsbane_blade | Zealotsbane Blade | weapon/mainhand | uncommon | 18 to 29 spd 2.3, str 6 sta 2 | 900 | warrior |
| emberwood_staff | Emberwood Staff | weapon/mainhand | uncommon | 20 to 33 spd 3.0, int 8 spi 3 | 900 | mage |
| cultist_flayer | Cultist Flayer | weapon/mainhand | uncommon | 12 to 19 spd 1.7 dagger, agi 7 | 900 | rogue |
| drogmars_skullcleaver | Drogmar's Skullcleaver | weapon/mainhand | rare | 22 to 35 spd 2.6, str 7 sta 4 | 2000 | warrior |
| ogre_bonecharm_staff | Ogre Bonecharm Staff | weapon/mainhand | rare | 24 to 38 spd 3.0, int 9 spi 4 | 2000 | mage |
| gutripper_shiv | Gutripper Shiv | weapon/mainhand | rare | 14 to 22 spd 1.7 dagger, agi 8 sta 3 | 2000 | rogue |
...
| staff_of_velkhar | Staff of Velkhar | weapon/mainhand | rare | 27 to 43 spd 3.0, int 10 spi 5 | 2500 | mage |
...
| wyrmfang_greatblade | Wyrmfang Greatblade | weapon/mainhand | **epic** | 30 to 48 spd 2.6, str 10 sta 6 | 8000 | warrior |
| staff_of_the_gravewyrm | Staff of the Gravewyrm | weapon/mainhand | **epic** | 32 to 52 spd 3.0, int 12 spi 6 | 8000 | mage |
| fang_of_korzul | Fang of Korzul | weapon/mainhand | **epic** | 19 to 30 spd 1.7 dagger, agi 11 sta 5 | 8000 | rogue |

## Vendor whites + food/drink tiers

Economy continuity: zone-2 quests pay 2 to 25s (total ≈ 1g31s + ~1g+ mob copper); zone-3 quests pay 5s, 2g50s (total ≈ 6g91s + mob copper). Vendor sets priced at roughly the band's quest income. Consume window fixed at 18s; tiers sized to pools at L13 (~550 hp / ~1,000 mana) and L20 (~810 hp / ~1,490 mana).
...
| bogiron_mace | Bogiron Mace | weapon (8 to 14 spd 2.6) | common | 2500 | 250 |
| fenreed_staff | Fenreed Staff | weapon (9 to 16 spd 3.0, int 1) | common | 2500 | 250 |
| mirefen_skinner | Mirefen Skinner | weapon (6 to 10 spd 1.8, dagger) | common | 2500 | 250 |
...
| highwatch_warblade | Highwatch Warblade | weapon (15 to 24 spd 2.3) | common | 6000 | 600 |
| craghorn_staff | Craghorn Staff | weapon (16 to 27 spd 3.0, int 2) | common | 6000 | 600 |
| icevein_dirk | Icevein Dirk | weapon (10 to 16 spd 1.8, dagger) | common | 6000 | 600 |
...
9. **Companion specs incorporated by reference** (already complete in `wf_0c329a02-def/journal.jsonl`, do not regenerate): ability ranks 1 to 20 for all nine classes (incl. the single new `finisherStun` AbilityEffect and mob-hp tuning anchor hp≈40+18L this spec's templates follow), the iconId-recipe icon system, and the tiered graphics plan.
