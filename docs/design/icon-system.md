# Procedural Icon System, Design Spec for Claudenarok Online

Everything below is implementable without further design decisions. Sources read: `/Users/reubenhorne/Documents/code/idkspvp/claudenarok/src/sim/data.ts`, `src/sim/types.ts`, `src/ui/hud.ts`, `index.html`.
...
export interface IconRecipe {
  ...
  prims: PrimitivePlacement[];      // drawn in order (1 to 2 typical)
